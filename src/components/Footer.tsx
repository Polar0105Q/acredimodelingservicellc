...
export default function Footer({ lang }: FooterProps) {
  ...
  return (
    <footer className="bg-[var(--brand-ink)] text-white border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
          <div className="md:col-span-4">
            ...
            >
              ...
              <span className="font-display font-semibold text-lg tracking-tight text-white transition-colors duration-300 group-hover:text-accent">
                AC Remodeling
                <span className="text-accent font-bold"> LLC</span>
                <sup className="text-xs opacity-60">®</sup>
              </span>
            </a>
            <p className="text-sm text-white/50 leading-relaxed max-w-xs mb-6">{tx.tagline}</p>
            <div className="flex gap-3" aria-label="Social profiles coming soon">
              {socialLinks.map((social) => (
                <span
                  key={social}
                  className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:border-primary/50 hover:bg-primary hover:text-primary-foreground hover:shadow-lg hover:shadow-primary/25"
                  aria-label={social}
                >
            ...
            <ul className="space-y-3">
              {tx.serviceItems.map((item) => (
                <li key={item}>
                  <a
                    href="#services"
                    className="group inline-flex items-center gap-2 text-sm text-white/60 transition-all duration-300 hover:translate-x-1 hover:text-white font-medium"
                  >
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li className="group flex items-start gap-2 text-sm text-white/60 transition-colors duration-300 hover:text-white">
                <Icon
                  name="PhoneIcon"
                  size={15}
                  variant="outline"
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center md:text-left">
            <p className="text-xs text-white/30">{tx.copyright}</p>
          ...
          <div className="flex gap-6">
            <a
              href="/privacy"
              className="relative text-xs text-white/40 transition-colors font-medium hover:text-white after:absolute after:-bottom-1 after:left-0 after:h-px after:w-0 after:bg-accent after:transition-all after:duration-300 hover:after:w-full"
            >
              {tx.privacy}
            </a>
            <a
