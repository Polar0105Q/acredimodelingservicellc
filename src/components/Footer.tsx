            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
                    ...
                    <div className="md:col-span-4">
                        ...
                        <p className="text-sm text-background/50 leading-relaxed max-w-xs mb-6">
                            {tx.tagline}
                        </p>
                    ...
                    <div className="md:col-span-3">
                        <p className="text-xs uppercase tracking-widest text-background/30 font-semibold mb-5">{tx.services}</p>
                        <ul className="space-y-3">
                            {[tx.kitchen, tx.bathroom, tx.home, tx.commercial, tx.flooring, tx.interior].map((s) => (
                                <li key={s}>
                                    <a href="#services" className="text-sm text-background/60 hover:text-background transition-colors duration-200 font-medium">
                                        {s}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="md:col-span-2">
                        <p className="text-xs uppercase tracking-widest text-background/30 font-semibold mb-5">{tx.company}</p>
                        <ul className="space-y-3">
                            {[
                                ...
                                <li key={item.href}>
                                    <a href={item.href} className="text-sm text-background/60 hover:text-background transition-colors duration-200 font-medium">
                                        {item.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    {/* Contact */}
                    <div className="md:col-span-3">
                        <p className="text-xs uppercase tracking-widest text-background/30 font-semibold mb-5">Contact</p>
                        <ul className="space-y-3">
                            <li className="flex items-start gap-2 text-sm text-background/60">
                                <Icon name="PhoneIcon" size={15} variant="outline" className="mt-0.5 shrink-0 text-accent" />
                                <span>(305) 555-0192</span>
                            </li>
                            <li className="flex items-start gap-2 text-sm text-background/60">
                                <Icon name="EnvelopeIcon" size={15} variant="outline" className="mt-0.5 shrink-0 text-accent" />
                                <span>info@remodelingservicellc.com</span>
                            </li>
                            <li className="flex items-start gap-2 text-sm text-background/60">
                                <Icon name="MapPinIcon" size={15} variant="outline" className="mt-0.5 shrink-0 text-accent" />
                                <span>Miami, FL 33101<br />Serving all of South Florida</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        <a href="#" className="text-xs text-background/40 hover:text-background transition-colors font-medium">{tx.privacy}</a>
                        <a href="#" className="text-xs text-background/40 hover:text-background transition-colors font-medium">{tx.terms}</a>
                    </div>
                </div>
            </div>
        </footer>
