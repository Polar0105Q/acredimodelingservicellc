      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
          <div className="md:col-span-4">
            ...
            >
              ...
              <span className="font-display font-semibold text-lg tracking-tight text-foreground transition-colors duration-300 group-hover:text-primary">
                AC Remodeling
            ...
            <div className="flex gap-3" aria-label="Social profiles coming soon">
              {socialLinks.map((social) => (
                <span
                  key={social}
                  className="w-9 h-9 rounded-xl bg-card border border-border flex items-center justify-center text-muted-foreground transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:border-primary/50 hover:bg-primary hover:text-primary-foreground hover:shadow-lg hover:shadow-primary/25"
                  aria-label={social}
                >
            ...
            <ul className="space-y-3">
              {tx.serviceItems.map((item) => (
                <li key={item}>
                  <a
                    href="#services"
                    className="group inline-flex items-center gap-2 text-sm text-muted-foreground transition-all duration-300 hover:translate-x-1 hover:text-foreground font-medium"
                  >
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li className="group flex items-start gap-2 text-sm text-muted-foreground transition-colors duration-300 hover:text-foreground">
                <Icon
                  name="PhoneIcon"
                  size={15}
                  variant="outline"
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center md:text-left">
            <p className="text-xs text-muted-foreground">{tx.copyright}</p>
          ...
          <div className="flex gap-6">
            <a
              href="/privacy"
              className="relative text-xs text-muted-foreground transition-colors font-medium hover:text-foreground after:absolute after:-bottom-1 after:left-0 after:h-px after:w-0 after:bg-accent after:transition-all after:duration-300 hover:after:w-full"
            >
              {tx.privacy}
            </a>
            <a
