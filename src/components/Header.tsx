...
export default function Header({ lang, theme, onLangChange, onThemeChange }: HeaderProps) {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
            <nav
                className={`w-full max-w-7xl flex items-center justify-between px-4 py-2.5 rounded-2xl transition-all duration-500 ${scrolled
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center bg-muted rounded-xl overflow-hidden border border-border">
                        <button
                            ...
                            className={`px-2.5 py-1.5 text-xs font-semibold transition-all duration-200 ${lang === 'en' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:text-foreground'
                                }`}
                        >
                            EN
                        </button>
                        <button
                            ...
                            className={`px-2.5 py-1.5 text-xs font-semibold transition-all duration-200 ${lang === 'es' ? 'bg-primary text-primary-foreground' : 'text-muted-foreground hover:text-foreground'
                                }`}
                        >
                            ES
                        </button>
