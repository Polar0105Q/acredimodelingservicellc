...
const testimonials = [
    {
        ...
        rating: 5,
        quote: 'Our kitchen went from a 1980s eyesore to the most beautiful room in the house. The team was professional, clean, and finished 3 days early. The quality is exceptional — every detail was considered.',
        quoteEs: 'Nuestra cocina pasó de ser un desastre de los 80 a la habitación más hermosa de la casa. El equipo fue profesional, limpio y terminó 3 días antes. La calidad es excepcional.',
        img: "https://img.rocket.new/generatedImages/rocket_gen_img_12c225ba7-1772167478205.png",
        imgAlt: 'Jennifer Castillo, a smiling woman in her 40s with dark hair, homeowner in Coral Gables',
    ...
    },
    {
        ...
        rating: 5,
        quote: 'They transformed our 4,000 sq ft office into a modern workspace that our team loves. Stayed on budget, on time, and the communication was outstanding throughout the entire project.',
        quoteEs: 'Transformaron nuestra oficina de 4,000 sq ft en un espacio moderno que nuestro equipo ama. Cumplieron con el presupuesto, el tiempo y la comunicación fue excelente.',
        img: "https://img.rocket.new/generatedImages/rocket_gen_img_16d40406a-1763299635779.png",
        imgAlt: 'Marcus Thompson, a professional man in his 50s in a suit, business owner in Brickell Miami',
    ...
    },
    {
        ...
        rating: 5,
        quote: 'I recommend Remodeling Service to all my clients. Their craftsmanship is flawless and they execute my designs exactly as intended. The 5-year warranty gives my clients complete peace of mind.',
        quoteEs: 'Recomiendo Remodeling Service a todos mis clientes. Su artesanía es impecable y ejecutan mis diseños exactamente como se pretende. La garantía de 5 años da tranquilidad total.',
...
export default function TestimonialsSection({ lang }: TestimonialsSectionProps) {
                ...
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        entry.target.querySelectorAll<HTMLElement>('.reveal').forEach((el, i) => {
                            setTimeout(() => { el.classList.add('animate-in-scroll'); }, i * 100);
                        });
                    }
                });
            },
    ...
    return (
        <section id="testimonials" ref={sectionRef} className="py-24 md:py-32 bg-secondary relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/3 right-0 w-96 h-96 blob-accent animate-blob opacity-20" />
                <div className="absolute bottom-0 left-1/4 w-64 h-64 blob-primary animate-blob opacity-15" style={{ animationDelay: '5s' }} />
            </div>
                    ...
                    <div className="flex flex-col gap-4 reveal">
                        {testimonials.map((t, i) =>
                            <button
                                key={t.name}
                                onClick={() => setActive(i)}
                                className={`flex items-start gap-4 p-5 rounded-2xl border text-left transition-all duration-300 ${active === i ?
