...
export default function HeroSection({ lang }: HeroSectionProps) {
    ...
    return (
        <section
            ...
            {/* Live badge */}
            <div className="absolute top-28 right-6 md:right-12 z-20 animate-slide-up opacity-0" style={{ animationDelay: '2.2s', animationFillMode: 'forwards' }}>
                <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl glass-card border border-white/15">
                    <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                    <span className="text-xs font-mono tracking-wider uppercase text-white/90">{tx.live}</span>
                </div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                ...
                <div className="md:col-span-7">
                    ...
                    <div
                        ...
                        <span className="text-xs font-mono uppercase tracking-widest text-accent">{tx.badge}</span>
                    </div>
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="grid grid-cols-3 gap-4 border-t border-white/15 pt-6 mb-8">
                                {[
                                    ...
                                    map((stat) =>
                                        <div key={stat.label}>
                                            <span className="block text-2xl font-display font-bold text-accent">{stat.val}</span>
                                            <span className="block text-xs uppercase tracking-wider text-white/40 mt-0.5">{stat.label}</span>
                                        </div>
                                    )}
                            </div>
