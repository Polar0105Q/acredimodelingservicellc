...
const t = {
    en: {
        ...
        imageAlt: 'Professional remodeling team reviewing blueprints in a bright modern kitchen under construction',
        stat1: '5-Year',
    ...
    es: {
        ...
        imageAlt: 'Equipo profesional de remodelación revisando planos en una moderna cocina en construcción',
        stat1: '5 Años',
                    ...
                    <div className="relative reveal">
                        ...
                        <div className="absolute -bottom-6 -right-4 flex flex-col gap-3">
                            <div className="glass-light rounded-2xl px-5 py-4 shadow-xl">
                                <span className="block text-2xl font-display font-bold text-primary">{tx.stat1}</span>
                                <span className="block text-xs uppercase tracking-wider text-muted-foreground mt-0.5">{tx.stat1l}</span>
                            </div>
                            <div className="glass-light rounded-2xl px-5 py-4 shadow-xl">
                                <span className="block text-2xl font-display font-bold text-accent-foreground">{tx.stat2}</span>
                                <span className="block text-xs uppercase tracking-wider text-muted-foreground mt-0.5">{tx.stat2l}</span>
                            </div>
                        </div>
