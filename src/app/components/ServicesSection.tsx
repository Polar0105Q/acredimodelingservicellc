      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Bathroom */}
          <div
            className="service-card group bg-card border border-border rounded-3xl p-7 flex flex-col justify-between min-h-[280px] cursor-pointer hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 reveal"
          ...
          {/* Home Renovation */}
          <div
            className="service-card group bg-accent/5 border border-accent/20 rounded-3xl p-7 flex flex-col justify-between min-h-[280px] cursor-pointer hover:bg-accent/10 hover:shadow-xl transition-all duration-300 reveal"
          ...
          <div
            className="lg:col-span-2 service-card group bg-foreground text-background rounded-3xl p-8 flex flex-col justify-between min-h-[280px] relative overflow-hidden cursor-pointer reveal"
