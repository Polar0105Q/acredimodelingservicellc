...
function StatItem({
  ...
  return (
    ...
    >
      ...
      <span className="mt-3 text-sm uppercase tracking-widest text-muted-foreground font-medium">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <section ref={ref} className="relative bg-secondary border-y border-border overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-48 h-48 blob-accent animate-blob opacity-40"
